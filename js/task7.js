...
создаваемый вызовом функции composeMessage. Значение this при вызове функции 
...
// мы используем это условие-
// let newArray = arr.map((currentValue, index) => callback.call((currentValue, index))
